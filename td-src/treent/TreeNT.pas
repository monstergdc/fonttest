...
//update: MoNsTeR/GDC, Jakub Noniewicz, noniewicz.com, 20111208 (d7/bds2006)
...
//JN  {$ifdef WithCommCrtl98} CommCtrl98, {$else} CommCtrl, {$endif}
  CommCtrl,
  ...
  //JN 20111208
resourcestring
  SListIndexError = 'ListIndexError';
  SListCapacityError = 'ListCapacityError';
  SListCountError = 'ListCountError';
...
//changed by MoNsTeR - didn't compile with this shit...         
